<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="samplePromotionAccount.aspx.cs" Inherits="Showcase.samplePromotionAccount" %>
    ...
    <div>
		<div id="main-body">
			<div id="main-body-inner" class="ie-rel-fix">
				<div class="section">
					<h1>Ejemplo 7: Ejemplo proceso registro en promoción (sección)</h1>
                    ...
                    <p>Apuntarse en Promoción</p>
                    <pre id="html_pre_promo1" runat=server></pre>
                    <pre id="html_pre_promo2" runat=server></pre>
                    <pre id="html_pre_promo3" runat=server></pre>
				</div>
			</div>
		</div>
    </div>
