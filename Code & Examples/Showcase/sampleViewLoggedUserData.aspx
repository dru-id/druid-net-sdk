<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sampleViewLoggedUserData.aspx.cs" Inherits="Showcase.sampleViewLoggedUserData" %>
    ...
    <div>
		<div id="main-body">
			<div id="main-body-inner" class="ie-rel-fix">
				<div class="section">
					<h1>Ejemplo 5: Consulta de datos del usuario logado</h1>    
                    ...
                    <p>Consulta de datos del usuario logado</p>
